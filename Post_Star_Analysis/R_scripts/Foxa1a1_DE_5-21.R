  ...
  keep_samples <- colData$condition %in% c("NTC", "FoxA2oe/A1kd")
  ...
  # 8. Extract results
  res <- topTable(fit, coef = "groupFoxA2oe/A1kd", number = Inf, sort.by = "logFC")
  ...
  # Save
  write.csv(res_annotated, file = "./5-21_Foxa1a2_res.csv", row.names = FALSE)
